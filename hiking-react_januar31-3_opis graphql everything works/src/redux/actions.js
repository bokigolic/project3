  ...
  return (dispatch) => {
    ...
    ajax.postAuthLogout()
      ...
      .then((response) => {
        ...
        */
        if (response && response.data && response.data.authLogout) {
  ...
  return (dispatch) => {
    ...
    ajax.postAuthRegister(entbox)
      ...
      .then((response) => {
        ...
        console.log(response);
        // if (response && response.is_success_response === true) {
        if (response && response.data && response.data.authRegister) {
          console.log(response);
          dispatch({
  ...
  return (dispatch) => {
    ...
    ajax.postAuthFormLogin(entbox)
      ...
      .then((response) => {
        ...
        console.log(response);
        // if (response && response.is_success_response === true) {
        if (response && response.data && response.data.authFormLogin) {
          console.log(response);
          // BACKEND LOGOUT FINISHED
          // now we do frontend logout procedure
          local_token_delete()
            .then(() => {
              dispatch({
                ...
                payload: response.data.authFormLogin
              });

              // KORAK cuvanje lokalnog tokena
              let token = 'notoken';
              if (typeof response.data.authFormLogin === 'string') {
                token = response.data.authFormLogin;
              }
              ...
              local_token_set(token)
                .then((token) => {
                  ...
                  ajax.getAuthMyUserData()
                    .then(response => ajax_fetch.response_json_smart(response))
                    .then((response) => {
                      if (response && response.data && response.data.myUserProfileData && response.data.myUserProfileData._id) {
                        console.log(response);
                        dispatch({
                          type: AUTH_GET_MY_USER_DATA_SUCCESS,
                          payload: {
                            user: response.data.myUserProfileData
                          }
                        });
                      }
                    })
  ...
  return (dispatch) => {
    ...
    ajax.postTourCreate(entbox)
      ...
      .then((response) => {
        ...
        console.log(response);
        // if (response && response.is_success_response === true) {
        if (response && response.data && response.data.tourCreate) {
          // console.log(response);
          dispatch({
  ...
  return (dispatch) => {
    ...
    ajax.postTourDelete(entbox)
      ...
      .then((response) => {
        ...
        // if (response.success === true) {
        console.log(response);
        if (response && response.data && response.data.tourDelete) {
          console.log(response);
          dispatch({
  ...
  return (dispatch) => {
    ...
    ajax.postTourUpdate(entbox)
      ...
      .then((response) => {
        ...
        console.log(response);
        // if (response && response.is_success_response === true) {
        if (response && response.data && response.data.tourUpdate) {
          // console.log(response);
          dispatch({
